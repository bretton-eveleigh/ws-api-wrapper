...
// note the additional [flog] argument, which forces inclusion of debug data in response:
$API_Call = "{$APIBaseURI}/{$APIVersion}/{$APIResource}/?h={$NonceHash}&{$QueryString}&flog";

// **********************************************************************************************
// POST request and output result:
...
$curlFile = new CURLFile('sample.xml');
...
// submit a file via post:
$postData = array('xmlfile' => $curlFile);
